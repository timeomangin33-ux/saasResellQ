  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(16,185,129,0.20),_transparent_32%),linear-gradient(135deg,_#020617_0%,_#050816_55%,_#020617_100%)]">
      ...
      <div className="relative flex min-h-screen">
        <div className="hidden lg:flex lg:w-[44%] flex-col justify-between border-r border-white/10 bg-slate-950/80 p-10 backdrop-blur-xl">
          <div>
            <Logo size="lg" />
            <div className="mt-12 space-y-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-400/20 bg-emerald-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.3em] text-emerald-300">
                Premium access
              </div>
        ...
        <div className="flex flex-1 flex-col">
          ...
          <div className="flex flex-1 items-center justify-center px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
            <div className="w-full max-w-md rounded-[28px] border border-white/10 bg-slate-950/70 p-6 shadow-[0_30px_90px_rgba(2,6,23,0.45)] backdrop-blur-xl sm:p-8">
              <div className="mb-8">
                <Link
                  href="/"
